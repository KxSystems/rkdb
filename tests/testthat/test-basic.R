...
test_that("kdb types to R types", {
  ...
  expect_equal(timestamp, as.POSIXct('2015-01-01T00:00:00.000000'))
  expect_is(month, "character")
  expect_equal(month, '2015.01')
  expect_is(date, "Date")
  expect_equal(date, as.Date('2015-01-01'))
  expect_is(datetime, "POSIXt")
  expect_equal(datetime, as.POSIXct('2006-07-21T09:13:39'))
  expect_is(timespan, "character")
  expect_equal(timespan, '12:00:00.000000000')
  expect_is(minute, "character")
  expect_equal(minute, '12:00')
  expect_is(second, "character")
  expect_equal(second, '12:00:00')
  expect_is(time, "character")
  expect_equal(time, '12:00:00.000')
...
test_that("R types to kdb types", {
  ...
  namedV <- execute(h, 'cc[;9h;((`a`b)!(1. 2.))]', c(a = 1., b = 2.))
  expect_equal(namedV, c(okType = TRUE, okValue = TRUE))
  namedL <-
    execute(h, 'cc[;9h;((`a`b)!(1. 2.))]', list(a = 1., b = 2.))
  expect_equal(namedL, c(okType = TRUE, okValue = TRUE))
